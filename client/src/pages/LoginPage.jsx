...
const LoginPage = () => {
  ...
  return (
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <img src={assets.logo_big} alt="" className='w-[min(50vw,415px)]'/>
       ...
       {currState === "Sign Up" && !isDataSubmitted && (
...

        {
          currState === "Sign Up" && isDataSubmitted && (
            ...
            placeholder='Short Bio' className='p-2 border border-gray-500 rounded-md 
        ...
        <div className="flex flex-col gap-2">
          {currState === "Sign Up" ? (
            <p className="text-sm text-gray-600">
              ...
              onClick={()=>{setCurrentState("Login") ; setIsDataSubmitted(false)}} className="font-medium text-violet-500 
              cursor-pointer">Login here</span>
            </p>
          ) : (
            <p className="text-sm text-gray-600">
              Create an account<span 
              onClick={()=>{setCurrentState("Sign Up")}} className="font-medium text-violet-500
